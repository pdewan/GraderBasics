...
public class AGradedClassProxyInvocationHandler implements InvocationHandler {
	...
	@Override
	public Object invoke(Object proxy, Method aProxyMethod, Object[] args) throws Throwable {
		...
		Assert.assertTrue("Method matching " + aProxyMethod.getName() + " not found in class: " + actualClass,
				anActualMethod != null);
...
//			if (aReturnType.isArray() { // old
//		      The array check isn't needed since it is implied by the next
//			if (aReturnType.isArray() && Object[].class.isAssignableFrom(aReturnType)) {
			if (Object[].class.isAssignableFrom(aReturnType)) {
