...
public class ATestLogFileWriter_Original extends RunListener {
	...
	public ATestLogFileWriter_Original() {
...
//		currentPassPercentage = (int) (100 * ((double) currentPasses.size())/totalTests);
	...
	public static void maybeCreateChecksFolder() {
        ...
        if (folder.mkdirs()) { // true if dirs made, false otherwise
            CheckersLogFolderCreated.newCase(folder.getAbsolutePath(), ATestLogFileWriter_Original.class);
        }
