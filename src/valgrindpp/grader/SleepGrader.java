...
public class SleepGrader extends AbstractGrader {
	public SleepGrader(String studentDir, String filename) throws Exception {
...
////		tests.add(countFuncCall("pthread_cond_wait", 19, 19));
		tests.add(countFuncCall("sleep", 20, 20));
