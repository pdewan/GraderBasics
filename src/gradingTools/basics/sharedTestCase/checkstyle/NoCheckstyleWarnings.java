...
@MaxValue(20)
@IsExtra(true)
public class NoCheckstyleWarnings extends CheckStyleWarningsTestCase {

	static final String MESSAGE = "No Checkstyle Warnings";
	public NoCheckstyleWarnings() {
		super (MESSAGE, MESSAGE);
	}
	

	
	public NoCheckstyleWarnings(String aTypeName, String aMessage) {
		super(aTypeName, aMessage);
		// TODO Auto-generated constructor stub
	}
	protected TestCaseResult noConfigurationTest(Project project, boolean autoGrade) throws NotAutomatableException,
...
//		return toConfigurationBasedResult(project, noConfigurationTest(project, autoGrade));
	...
	@Override
	protected double computeScore(Project aProject, String[] aCheckStyleLines, List<String> aFailedMatchedLines,
			List<String> aSucceededMatchedLines, boolean autoGrade) {
