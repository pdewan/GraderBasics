...
public class CheckstyleCommonMethodCalledTestCase extends CheckStyleTestCase {

	 protected String method;
	 protected String otherMethod;
...
//	 protected String typeName;
	 public CheckstyleCommonMethodCalledTestCase(
			 String aType, 
			 String aMethod, 
			 String anotherMethod,
			 String aCommonMethod) {
	        super(aType, aMethod);
//	        super(aType, aType + "!" + aMethod);

	        typeTag = aType;
	        method = aMethod;
	        otherMethod = anotherMethod;
	        commonMethod = aCommonMethod;
