...
public class SimplifyBooleanReturnTestCase extends CheckstyleSpecificWarningTestCase {

	static final String WARNING = "SimplifyBooleanReturn";
	public SimplifyBooleanReturnTestCase() {
		super (WARNING);
	}
