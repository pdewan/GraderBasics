...
public class EncapsulationTestCase extends CheckstyleSpecificWarningTestCase {

	static final String WARNING = "VisibilityModifier";
	public EncapsulationTestCase() {
		super (WARNING);
	}
