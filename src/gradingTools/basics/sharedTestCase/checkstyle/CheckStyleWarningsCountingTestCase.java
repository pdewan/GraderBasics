...
public  class CheckStyleWarningsCountingTestCase extends CheckStyleWarningsTestCase {
	public static final double DEFAULT_PENALTY_PER_MISTAKE = 0.2;
	protected double penaltyPerMistake = DEFAULT_PENALTY_PER_MISTAKE;

	public CheckStyleWarningsCountingTestCase(String aTypeName, String aMessage) {
		super(aTypeName, aMessage);
	}
	
	public CheckStyleWarningsCountingTestCase(String aTypeName, String aMessage, double aPenaltyPerMistake) {
		super(aTypeName, aMessage);
