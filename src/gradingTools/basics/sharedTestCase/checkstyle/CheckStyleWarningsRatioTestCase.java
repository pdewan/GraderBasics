...
//	protected double penaltyPerMistake = DEFAULT_PENALTY_PER_MISTAKE;
	...
	public CheckStyleWarningsRatioTestCase(String aTypeName, String aMessage, double aPenaltyPerMistake) {
		super(aTypeName, aMessage);
...
//        return partialPass(score, beautify(aMatchedLines));
		...
		if (aNumFailedLines == 0 && aNumSucceededLines == 0) return 1;
		return aNumSucceededLines/(aNumSucceededLines + aNumFailedLines);
