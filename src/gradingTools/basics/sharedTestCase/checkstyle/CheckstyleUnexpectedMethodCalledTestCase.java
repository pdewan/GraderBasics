...
public class CheckstyleUnexpectedMethodCalledTestCase extends CheckStyleTestCase {
...
//	 protected String typeName;
	 public CheckstyleUnexpectedMethodCalledTestCase(String aType, String aCallingMethod, String aMethod) {
	        super(aType, aMethod);
...
//		return "(.*)" + getActualType() + "(.*)" + WARNING_NAME + "(.*)" + method + "(.*)";
		return ".*" + "WARN" + ".*" + callingMethod + ".*" + typeTag + "(.*)" + method + "(.*)" + "\\[UnexpectedMethodCall\\]" + ".*" ;
...
//		return "(.*)" + getActualType() + " has not made expected call(.*)" + method + "(.*)";
	...
	public String positiveRegexLineFilter() {
		return ".*" + "INFO" + ".*" + callingMethod + ".*" +typeTag + "(.*)" + method + "(.*)" + "\\[UnexpectedMethodCall\\]" + ".*";
