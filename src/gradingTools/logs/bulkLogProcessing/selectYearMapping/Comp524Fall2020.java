...
//		//Name was changed mid assignment
//		testPool.add(new SuiteTestPairings("StyleSuite","A1NoCheckstyleWarnings")); //all ec
//		testPool.add(new SuiteTestPairings("StyleSuite","A1NamedConstants"));
//		testPool.add(new SuiteTestPairings("StyleSuite","A1PublicMethodsOverride"));
//		testPool.add(new SuiteTestPairings("StyleSuite","A1InterfaceAsType"));
//		testPool.add(new SuiteTestPairings("StyleSuite","A1MnemonicNames"));
//		testPool.add(new SuiteTestPairings("StyleSuite","A1AccessModifiersMatched"));
