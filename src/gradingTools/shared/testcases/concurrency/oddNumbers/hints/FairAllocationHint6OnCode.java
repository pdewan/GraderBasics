...
@MaxValue(0)
@Explanation("This hint tries to identify parts of the code in fairThreadRemainderSize() that are leading to the error message from FairAllocationSmallProblem")
public class FairAllocationHint6OnCode extends FairAllocationHint5OnCode {
...
//	}
	...
	protected String hint() {
		...
		String aPrefix = "\nIn method fairThreadRemainderSize ";
