...
public class HangingHint2OnOutput extends HangingHint{
	...
	protected String hint() {
		String aLine1 = "Recall what happens when a thread tries to enter a synchrnnized method";
		String aLine2 = "Read the comments above the class SynchronizationDemo if necessary";		
