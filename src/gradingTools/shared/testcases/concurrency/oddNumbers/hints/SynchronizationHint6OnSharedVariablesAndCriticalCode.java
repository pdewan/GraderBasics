...
public class SynchronizationHint6OnSharedVariablesAndCriticalCode extends SynchronizationHint{
	...
	protected String hint() {
		...
		String aLine3 = "To find the methods changing them, look in the code";
		String aLine4 = "strings \"traceLoad\", \"traceList\"";
		String aLine5 = "Look in the assignment description about Synchronization Theory to understand how to create ciritical codei in Java";
